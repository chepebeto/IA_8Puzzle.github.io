...
function time() {
  ...
  document.getElementById("logStates").innerHTML+="<br> Puzzle No Resuelto: [".concat(puzzle).concat("]");
  document.getElementById("logStates").innerHTML+="<br>";

  for (var i = 0; i<result.length; i++){
    document.getElementById("logStates").innerHTML+="<br>".concat(i).concat(" : &emsp; Hijo seleccionado =  <b>[").concat(result[i]).concat("]</b>");
  }
  document.getElementById("logStates").innerHTML+="<br>";
  document.getElementById("logStates").innerHTML+="<br>Puzzle Resuelto : &emsp;  <b>[".concat(result[result.length-1]).concat("]</b>");
